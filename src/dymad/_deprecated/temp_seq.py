...
class TemplateSeq(ModelBase):
    """
    Template class for time-delayed states and inputs.
    Handles RNN-based encoder/decoder construction and common methods.
    Same architecture for both cont-time and disc-time.

    Below X and U denote sequences of states and inputs, respectively, and
    z may or may not denote time-delayed latent states, depending on the dynamics model.
